	...
	public void setupRenderHook() {
		if (this.lookBehindProgress != 0 && this.mc.renderViewEntity != null) {
			...
			if (this.cpEntity == null) {
				...
				this.cpEntity =
					new ControlPackEntity(this.mc, this.mc.theWorld, new Session(null, null, null, null), 0/*dimension??*/);
...
//System.out.println("ControlPack: No need to wrap entity right now...");
    ...
    public boolean handleInputEvent(int code, boolean down) {
        ...
        if (code == 63 && down && booleanOptions.get(ControlPackEnumOptions.FRONTVIEW)) {
