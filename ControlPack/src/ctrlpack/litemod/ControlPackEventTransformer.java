...
public class ControlPackEventTransformer extends EventInjectionTransformer {
	...
	protected void addEvents() {
		//GuiFurnace
		this.addEvent(Event.getOrCreate("ControlPack_GuiFurnace", true), new MethodInfo(ControlPackObfTable.GuiContainer, ControlPackObfTable.GuiScreen_mouseClicked, Void.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE), new MethodHead()).addListener(new MethodInfo("ctrlpack.litemod.LiteModControlPack", "guiFurnaceMouseClick"));
